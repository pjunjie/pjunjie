...
## Research
<p>在罗昕副教授的指导下, 针对流式跨媒体数据检索中的层次类别增量问题进行了研究, 通过独立进行论文阅读, 理论推导, 编写代码进行实验检验等工作, 对跨媒体计算有一定的了解。目前有一篇我是<b>独立第一作者的论文产出</b>, 论文原稿在导师处审校和准备投稿<b>IEEE Transactions on Multimedia（TMM,CCF-B,中科院一区）</b></p>
